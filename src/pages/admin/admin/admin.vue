...
<script>
    //请求前缀
    const indexUrl = '/admin/admin/index'
    const deleteUrl = '/admin/admin/delete'
    const primaryName = 'id'
    const componentName = 'admin'

    // 导入组件
    import crud_insert_form from "./admin_insert_form";
    import crud_update_form from "./admin_update_form";
